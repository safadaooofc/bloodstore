  ...
  return (
    <footer className="footer-container">
      <div className="footer-grid">
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem', cursor: 'pointer' }} onClick={() => setActiveView('home')}>
            <div style={{ width: '40px', height: '40px', background: '#121218', border: '1px solid var(--color-neon-red)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderRadius: '8px' }}>
              <img 
          ...
          <p style={{ color: '#a0a0b2', fontSize: '0.86rem', lineHeight: 1.6, fontWeight: 300, marginBottom: '1.25rem' }}>
            Referência em soluções e serviços digitais no Brasil. Processamento ágil, transações verificadas e atendimento técnico contínuo em nosso canal corporativo.
          </p>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.65rem', fontSize: '0.88rem', color: '#d0d0e0' }}>
            ...
            <li>
              <a href={config.globalDiscordUrl} target="_blank" rel="noopener noreferrer" style={{ color: '#ff003c', textDecoration: 'none' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', fontSize: '0.84rem', color: '#a0a0b2', fontWeight: 300 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              ...
              <span>Transações Auditadas & Seguras</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              <Terminal style={{ width: '16px', height: '16px', color: '#ff003c', flexShrink: 0 }} />
              <span>Disponibilização Automatizada</span>
            </div>
        ...
        <div>
          ...
          <p style={{ color: '#a0a0b2', fontSize: '0.86rem', lineHeight: 1.6, fontWeight: 300, marginBottom: '1.25rem' }}>
            Necessita de orientação técnica sobre nossos serviços ou acompanhamento do seu pedido? Nossa central está disponível para atendimento.
          </p>
          <a 
            ...
            style={{ padding: '0.65rem 1.25rem', fontSize: '0.78rem', width: '100%', textAlign: 'center', display: 'flex', justifyContent: 'center' }}
          >
      ...
      <div style={{ maxWidth: '1280px', margin: '3rem auto 0 auto', paddingTop: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: '#666677' }}>
        <div>BLOOD STORE • PLATAFORMA DE ATIVOS DIGITAIS</div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
          <span>Desenvolvido com excelência técnica por Kiover</span>
